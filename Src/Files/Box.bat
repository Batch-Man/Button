...
:: it is technically ver.6.0 of Box function... and it contains diffrnet types of Box printing options... #kvc
...
rem :: Visit www.batch-man.com for more extensions / plug-ins like this.... :]
rem #BatchMan
...
set "color=%~7"
if defined color (if /i "!color!" == "-" (set color=) Else (set "color=/c 0x!color!"))
